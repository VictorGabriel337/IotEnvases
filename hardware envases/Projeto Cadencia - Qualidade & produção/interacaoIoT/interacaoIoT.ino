  ...
  if (client) {
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        // Responde com o valor do sensor e cabeçalhos CORS
        client.println("HTTP/1.1 200 OK");
        client.println("Content-Type: application/json");
        client.println("Access-Control-Allow-Origin: *");  // Permite qualquer origem
        client.println("Connection: close");
        client.println();  // Linha em branco obrigatória
        client.print("{\"lowSignalCount\": ");
        client.print(lowSignalCount);
        client.print(", \"cadenceTotalTime\": ");
        client.print(cadenceTotalTime / 1000);
        client.print(", \"nonCadenceTotalTime\": ");
        client.print(nonCadenceTotalTime / 1000);
        client.println("}");
        delay(100);
        //client.stop();
